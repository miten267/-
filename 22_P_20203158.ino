...
// Distance sensor
#define _DIST_ALPHA 0.0  // [3162] ema 필터의 alpha 값을 0.0으로 설정

// Servo range
#define _DUTY_MIN 1000    //[3148]  서보의 가동 최소 각도(0)
#define _DUTY_NEU 1490      //[3150] servo neutral position (90 degree)
...
#define _SERVO_SPEED 80             //[3147]  서보 속도를 30으로 설정
...
int a, b;
const float coE[] = {-0.0000054, 0.0025202, 0.8393528, 61.7378886};
