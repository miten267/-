...
// Distance sensor
#define _DIST_ALPHA 0.45  // [3162] ema 필터의 alpha 값을 0.0으로 설정

// Servo range
#define _DUTY_MIN 1410    //[3148]  서보의 가동 최소 각도(0)
#define _DUTY_NEU 1560      //[3150] servo neutral position (90 degree)
#define _DUTY_MAX 1710                // [3169] 서보의 최대 가동 각도(180º)

// Servo speed control
#define _SERVO_ANGLE 30   //[3159] 서보의 각도(30º) 
//[3150] 레일플레이트가 사용자가 원하는 가동범위를 움직일때, 이를 움직이게 하는 서보모터의 가동범위
#define _SERVO_SPEED 300             //[3147]  서보 속도를 30으로 설정
...
float dist_raw, dist_ema, dist_filtered;    //[3160] 실제 거리측정값과 ema필터를 적용한 값을 저장할 변수
int a, b;
const float coE[] = {0.0000031, -0.0021731, 1.6499601, -21.6761457};
...
////////////////////
  ...
  // get a distance reading from the distance sensor
      dist_filtered = ir_distance_filtered();  // [3157] 적외선 선세로 측정한 값에 필터를 적용한 값
...
float ir_distance(void){ // return value unit: mm
  ...
  return caliVal;         //[3150] 적외선 센서를 통해 거리를 return시킨다.
}
